...
int			hit_sphere(t_sphere sphere, t_ray *ray, t_range t,
				t_ray_hit *rec);
void		set_face_normal(t_ray_hit *rec, t_ray *ray,
				t_vector *out_normal);
int			trace_ray_hit(t_object *list, t_ray *ray, t_range t,
				t_ray_hit *rec);
int			hit_plane(t_plane plane, t_ray *ray, t_range t,
				t_ray_hit *rec);
int			hit_cylinder(t_cylinder *cyl, t_ray *ray, t_range t,
				t_ray_hit *rec);
...
int			is_shadowed(t_vector point, t_light light, t_object *world,
				int ignored);
int			set_record(double *closest, t_ray_hit *tr, t_ray_hit *rec, \
				int index);
int			hit_object(t_object *obj, t_ray *ray, t_range t_var, \
				t_ray_hit *tr);
