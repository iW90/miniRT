...
/*   Updated: 2024/03/17 21:01:16 by maalexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	add_intersection(t_intersect **head, t_ray ray, t_object *obj, float t)
{
	...
	*new_intersection = (t_intersect){0};
	...
	new_intersection->normal = check_object_normal(obj, new_intersection->point);
	new_intersection->object = obj;
	insert_sorted(head, new_intersection);
}
